...
Version  : 2.2.0
Release  : 6
URL      : http://pypi.debian.net/pycodestyle/pycodestyle-2.2.0.tar.gz
Source0  : http://pypi.debian.net/pycodestyle/pycodestyle-2.2.0.tar.gz
...
%prep
%setup -q -n pycodestyle-2.2.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1484563554
