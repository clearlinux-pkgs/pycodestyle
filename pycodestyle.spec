...
%prep
%setup -q -n pycodestyle-2.7.0
cd %{_builddir}/pycodestyle-2.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615845911
...
cp %{_builddir}/pycodestyle-2.7.0/LICENSE %{buildroot}/usr/share/package-licenses/pycodestyle/0b3a0b386cf2762bc7b475c9855cdec47dd70a38
